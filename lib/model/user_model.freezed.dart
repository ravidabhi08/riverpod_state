...
// This required field represents the id of the user
  int get id =>
      throw _privateConstructorUsedError; // This required field represents the login name of the user
  String get login =>
      throw _privateConstructorUsedError; // This required field represents the node id of the user
...
// This required field represents the id of the user
  @override
  int get id; // This required field represents the login name of the user
  @override
  String get login; // This required field represents the node id of the user
// ignore: non_constant_identifier_names
  @override
  String get node_id; // ignore: non_constant_identifier_names
  @override
